...
// form components
const AssetForm = Loadable(lazy(() => import('../views/form-layouts/FormAssetLayout')))
const PlantForm = Loadable(lazy(() => import('../views/form-layouts/FormAssetLayout')))
const CircuitForm = Loadable(lazy(() => import('../views/form-layouts/FormCircuitLayout')))
const AreaForm = Loadable(lazy(() => import('../views/form-layouts/FormAreaLayout')))
const CmlForm = Loadable(lazy(() => import('../views/form-layouts/FormCmlLayout')))
...
const Router = [ 
  {
    ...
    children: [
      ...
      { path: '/form-layouts/form-layouts/assets', element: <AssetForm/> },
      { path: '/form-layouts/form-layouts/area', element: <AreaForm/> },
      { path: '/form-layouts/form-layouts/circuits', element: <CircuitForm/> },
      { path: '/form-layouts/form-layouts/cml', element: <CmlForm/> },
